...
func (p *Peg) Init() {
	...
	rules = [...]func() bool{
		...
		nil,
		/* 84 Action44 <- <{ p.AddHexaCharacter(buffer[begin:end]) }> */
		nil,
		/* 85 Action45 <- <{ p.AddOctalCharacter(buffer[begin:end]) }> */
		nil,
		/* 86 Action46 <- <{ p.AddOctalCharacter(buffer[begin:end]) }> */
		nil,
